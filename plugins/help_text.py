    ...
    if update_channel:
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton('Support Channel', url='https://t.me/THE_ALL_BOTZ'),
                    InlineKeyboardButton('MOVIES', url='https://t.me/TORZAN_MOVIE')
                ],
                [
                    InlineKeyboardButton('Other Bots', url='https://t.me/FREEKZZ_BOTZ'),
                    InlineKeyboardButton('Source', url='https://t.me/FREEKZZ_BOTZ')
                ]
            ]
        ),
